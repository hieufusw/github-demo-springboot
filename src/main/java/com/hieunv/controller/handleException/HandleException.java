package com.hieunv.controller.handleException;

import com.hieunv.common.exception.*;
...
public class HandleException {
    ...
    public ErrorInfo asyncTimeout(AsyncRequestTimeoutException e){
		e.printStackTrace();
    ...
    public ErrorInfo httpMediaTypeNotAcceptableException(HttpMediaTypeNotAcceptableException e){
		e.printStackTrace();
		return new ErrorInfo(ExceptionCode.ERROR_RUNTIME, e.getMessage()); 
    }
	...
	public Object handleImportException(ImportException e) {
		return e.getListErrorImport();
	}
	...
	public ErrorInfo handleConstraintViolationException(ConstraintViolationException e) {
		...
		errorInfo.setSimpleMessage(msgBuider.toString());
		return errorInfo;
	}
	...
	public ErrorInfo handleValidBusinessException(BusinessException e) {
		e.printStackTrace();
		return new ErrorInfo(e.getCode(), e.getSimpleMessage());
	}
